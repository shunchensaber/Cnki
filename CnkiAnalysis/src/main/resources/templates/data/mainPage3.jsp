...
<body class="gray-bg sidebar-content">
    ...
    <script src="<%=path%>/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="<%=path%>/js/plugins/flot/curvedLines.js"></script>
    ...
    <script src="<%=path%>/js/demo/sparkline-demo.min.js"></script>
    <script>
