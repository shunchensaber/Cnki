...
<body>
	<div class="row">
		<div class="col-sm-12" id="map" style="height:600px;border:1px solid #ccc;padding:10px;"></div>
	</div>
    ...
    <script src="<%=path %>/js/echarts/china.js"></script>
    <script src="<%=path %>/js/echarts/echarts.js"></script>
    <script src="http://api.map.baidu.com/api?v=2.0&ak=sYVnAXX43USSVPlnPt3CGwsVH4j17Zz4"></script>
